     <div class="box">
                            ...
                            <div class="box-content">
                                <p><h5><b style="color: coral">Gadget World is an online based Computer gadgets retail store. All types of imported brand new Computer gadgets are available here. Save your money and time with the best quality dealing store. Our main vision is to develop an advanced IT gadgets retail store with exhibition concept to provide the best service, endorsed by competent human resources and professional business partners and supported by excellent services having full range facilities to only extend consumer satisfaction.</b></h5></p>
                            </div>
                        </div>
                        <div class="box">
                            <div class="banner">
                            ...
                            <div class="box-content">
                                <div class="box-product fixed">
                                    <?php
                                        ...
                                        {
                                    ?>
                                    <div class="prod_hold"> <a class="wrap_link" href="<?php echo base_url();?>Welcome/product_details/<?php echo $v_product->product_id ;?>"> <span class="image"><img src="<?php echo base_url().$v_product->product_image?>" width="150" height="150" alt="Spicylicious store" /></span> </a>
